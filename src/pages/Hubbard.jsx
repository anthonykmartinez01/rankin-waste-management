    ...
    <>
      ...
      <section className="px-6 lg:px-[clamp(2rem,5vw,4rem)] py-20 md:py-28">
        <div className="max-w-[800px] mx-auto">
          ...
          {/* Weekly Residential */}
          <div ref={weekly.ref} style={weekly.style} className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Weekly residential trash pickup in Hubbard</h2>
            <p className="text-text-muted text-lg leading-relaxed mb-6">
          ...
          {/* Garbage Removal */}
          <div ref={garbage.ref} style={garbage.style} className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Garbage removal in Hubbard</h2>
            <p className="text-text-muted text-lg leading-relaxed mb-6">
          ...
          {/* Curbside Collection */}
          <div ref={curbside.ref} style={curbside.style} className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Curbside trash collection in Hubbard</h2>
            <p className="text-text-muted text-lg leading-relaxed mb-6">
          ...
          {/* Rural Service */}
          <div ref={rural.ref} style={rural.style} className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Rural trash service in Hubbard</h2>
            <p className="text-text-muted text-lg leading-relaxed mb-6">
          ...
          <div ref={cta.ref} style={cta.style} className="bg-dark-elevated border border-border-subtle rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Get Reliable Waste Management in Hubbard</h2>
