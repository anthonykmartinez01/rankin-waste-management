...
### 7a. (RESOLVED 2026-05-04) NAP / hours data inconsistency
- **Status:** ✅ RESOLVED — all 5 sources of hours data reconciled to **Mon-Fri 8AM-6PM, closed Sat/Sun** (confirmed correct hours per Tommy/Sydney).
- **Fixed in commit on 2026-05-04:**
  - `src/data/business.ts` — Mon-Fri now `8:00 AM – 6:00 PM`; Saturday now `Closed` (was `7:00 AM – 6:00 PM` weekdays + `Saturday 8:00 AM – 4:00 PM`)
  - `src/pages/index.astro` — `LocalBusiness.openingHours` now `["Mo-Fr 08:00-18:00"]` (was `["Mo-Fr 07:00-18:00", "Sa 08:00-16:00"]`)
  - `src/pages/service-areas/axtell.astro` — CTA copy now reads "Monday through Friday from 8 AM to **6 PM**" (was 5 PM)
  - `src/components/Footer.astro` — already correct, comment updated
  - `src/pages/contact-us.astro` — already correct, comment updated
- All five sources now agree: Mon-Fri 8AM-6PM, no Saturday.
